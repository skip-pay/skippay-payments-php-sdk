...
class HealthCheckApi
{
    ...
    /**
     * Exception handler for aPIhealthcheck.
     *
     * @param \SkipPay\ApiException $e Unprocessed exception.
     *
     * @return \SkipPay\ApiException Processed exception.
     */
    protected function aPIhealthcheckHandleException(ApiException $e): ApiException
    {
        switch ($e->getCode()) {
        }
        return $e;
     ...
     * @return \SkipPay\Model\HealthCheckResponse
     */
    public function aPIhealthcheck($contentType)
    {
        return $this->aPIhealthcheckWithHttpInfo($contentType)[0];
    }
     ...
     *     \SkipPay\Model\HealthCheckResponse,
     *     int,
     *     array<array<string>>
     * }
     */
    public function aPIhealthcheckWithHttpInfo($contentType)
    {
        ...
        try {
            ...
            switch ($response->getStatusCode()) {
                case 200:
                    return $this->responseToReturn(
                        $response,
                        \SkipPay\Model\HealthCheckResponse::class
                    );
                default:
                    return $this->responseToReturn(
                        $response,
            ...
            throw $this->aPIhealthcheckHandleException($e);
        }
    }
     ...
     */
    public function aPIhealthcheckAsync($contentType)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function aPIhealthcheckAsyncWithHttpInfo($contentType)
    {
        $request = $this->aPIhealthcheckRequest($contentType);
        return $this->makeAsyncRequest(
            $request,
            [$this, 'aPIhealthcheckHandleException']
        )->then(
            function ($r) {
     ...
     */
    public function aPIhealthcheckRequest($contentType)
    {
        ...
        return ObjectSerializer::createRequest(
            ...
            array_merge(
                [
                    'Content-Type' => ObjectSerializer::toHeaderValue($contentType),
                ],
                $headers
            ),
            // Form Params
