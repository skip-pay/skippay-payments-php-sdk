...
class PrecheckApi
{
    ...
    /**
     * Exception handler for precheck.
     *
     * @param \SkipPay\ApiException $e Unprocessed exception.
     *
     * @return \SkipPay\ApiException Processed exception.
     */
    protected function precheckHandleException(ApiException $e): ApiException
    {
        switch ($e->getCode()) {
            case 400:
                $e->setResponseObject(
     ...
     * Precheck
     *
     * @param \SkipPay\Model\PrecheckRequest|null $precheckRequest
     *
     * @throws \SkipPay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SkipPay\Model\PrecheckResultsResponse
     */
    public function precheck($precheckRequest = null)
    {
        return $this->precheckWithHttpInfo($precheckRequest)[0];
    }
     ...
     *     \SkipPay\Model\PrecheckResultsResponse,
     *     int,
     *     array<array<string>>
     * }
     */
    public function precheckWithHttpInfo($precheckRequest = null)
    {
        $request = $this->precheckRequest($precheckRequest);
        try {
            ...
            switch ($response->getStatusCode()) {
                case 200:
                    return $this->responseToReturn(
                        $response,
                        \SkipPay\Model\PrecheckResultsResponse::class
                    );
                default:
                    return $this->responseToReturn(
                        $response,
            ...
            throw $this->precheckHandleException($e);
        }
    }
     ...
     */
    public function precheckAsync($precheckRequest = null)
    {
        return $this->precheckAsyncWithHttpInfo($precheckRequest)
            ->then(
                /**
                 * @phpstan-param array{
                 *     \SkipPay\Model\PrecheckResultsResponse,
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function precheckAsyncWithHttpInfo($precheckRequest = null)
    {
        $request = $this->precheckRequest($precheckRequest);
        return $this->makeAsyncRequest(
            $request,
            [$this, 'precheckHandleException']
        )->then(
            function ($r) {
    ...
    /**
     * Create request for operation 'precheck'
     *
     * @param \SkipPay\Model\PrecheckRequest|null $precheckRequest
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function precheckRequest($precheckRequest = null)
    {

        $resourcePath = '/financing/v1/precheck';
