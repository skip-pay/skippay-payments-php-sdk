...
/**
 * OrderExtendedResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderExtendedResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderExtendedResponse';
    ...
    public function setNumber($number)
    {
        if ((mb_strlen($number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $number when calling OrderExtendedResponse., must be smaller than or equal to 100.');
        }
    ...
    public function setDeliveryTrackingNumber($deliveryTrackingNumber)
    {
        if ((mb_strlen($deliveryTrackingNumber) > 64)) {
            throw new \InvalidArgumentException('invalid length for $deliveryTrackingNumber when calling OrderExtendedResponse., must be smaller than or equal to 64.');
        }
