...
/**
 * PartnerLogin Class Doc Comment
 *
 * @category Class
 ...
 */
class PartnerLogin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartnerLogin';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['username'] === null) {
            $invalidProperties['username'] = "'username' can't be null";
        }
        if ($this->container['password'] === null) {
            $invalidProperties['password'] = "'password' can't be null";
        }
     ...
     * Sets password
     *
     * @param string $password Partner secret password
     *
     * @return self
     */
