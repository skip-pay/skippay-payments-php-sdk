...
/**
 * OrderItemsDeliverRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderItemsDeliverRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderItemsDeliverRequest';
    ...
    public function setVariableSymbol($variableSymbol)
    {
        if (!is_null($variableSymbol) && (mb_strlen($variableSymbol) > 10)) {
            throw new \InvalidArgumentException('invalid length for $variableSymbol when calling OrderItemsDeliverRequest., must be smaller than or equal to 10.');
        }
    ...
    public function setSpecificSymbol($specificSymbol)
    {
        if (!is_null($specificSymbol) && (mb_strlen($specificSymbol) > 10)) {
            throw new \InvalidArgumentException('invalid length for $specificSymbol when calling OrderItemsDeliverRequest., must be smaller than or equal to 10.');
        }
    ...
    public function setDeliveryTrackingNumber($deliveryTrackingNumber)
    {
        if (!is_null($deliveryTrackingNumber) && (mb_strlen($deliveryTrackingNumber) > 64)) {
            throw new \InvalidArgumentException('invalid length for $deliveryTrackingNumber when calling OrderItemsDeliverRequest., must be smaller than or equal to 64.');
        }
     ...
     * Sets deliveryDate
     *
     * @param \DateTime|null $deliveryDate Delivery date
     *
     * @return self
     */
