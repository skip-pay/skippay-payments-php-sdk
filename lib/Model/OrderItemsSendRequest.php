...
/**
 * OrderItemsSendRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderItemsSendRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderItemsSendRequest';
    ...
    public function setVariableSymbol($variableSymbol)
    {
        if (!is_null($variableSymbol) && (mb_strlen($variableSymbol) > 10)) {
            throw new \InvalidArgumentException('invalid length for $variableSymbol when calling OrderItemsSendRequest., must be smaller than or equal to 10.');
        }
    ...
    public function setSpecificSymbol($specificSymbol)
    {
        if (!is_null($specificSymbol) && (mb_strlen($specificSymbol) > 10)) {
            throw new \InvalidArgumentException('invalid length for $specificSymbol when calling OrderItemsSendRequest., must be smaller than or equal to 10.');
        }
    ...
    public function setDeliveryTrackingNumber($deliveryTrackingNumber)
    {
        if (!is_null($deliveryTrackingNumber) && (mb_strlen($deliveryTrackingNumber) > 64)) {
            throw new \InvalidArgumentException('invalid length for $deliveryTrackingNumber when calling OrderItemsSendRequest., must be smaller than or equal to 64.');
        }
