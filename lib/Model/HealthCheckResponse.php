...
class HealthCheckResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['projectVersion'] = $data['projectVersion'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['projectVersion'] === null) {
            $invalidProperties['projectVersion'] = "'projectVersion' can't be null";
        }
    ...
    {
        return $this->container['projectVersion'];
    }
    ...
    {
        $this->container['projectVersion'] = $projectVersion;
