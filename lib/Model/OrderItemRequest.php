...
class OrderItemRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCode($code)
    {
        if ((mb_strlen($code) > 200)) {
            throw new \InvalidArgumentException('invalid length for $code when calling OrderItemRequest., must be smaller than or equal to 200.');
        }
    ...
    public function setEan($ean)
    {
        if (!is_null($ean) && (mb_strlen($ean) > 64)) {
            throw new \InvalidArgumentException('invalid length for $ean when calling OrderItemRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling OrderItemRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setVariant($variant)
    {
        if (!is_null($variant) && (mb_strlen($variant) > 250)) {
            throw new \InvalidArgumentException('invalid length for $variant when calling OrderItemRequest., must be smaller than or equal to 250.');
        }
    ...
    public function setProducer($producer)
    {
        if (!is_null($producer) && (mb_strlen($producer) > 250)) {
            throw new \InvalidArgumentException('invalid length for $producer when calling OrderItemRequest., must be smaller than or equal to 250.');
        }
    ...
    public function setProductUrl($productUrl)
    {
        if (!is_null($productUrl) && (mb_strlen($productUrl) > 200)) {
            throw new \InvalidArgumentException('invalid length for $productUrl when calling OrderItemRequest., must be smaller than or equal to 200.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (!is_null($quantity) && ($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling OrderItemRequest., must be bigger than or equal to 1.');
        }
