...
/**
 * RecurrenceObject Class Doc Comment
 *
 * @category Class
 * @package  SkipPay
 * @author   OpenAPI Generator team
 ...
 */
class RecurrenceObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecurrenceObject';
     ...
     * Sets state
     *
     * @param string $state Recurrence state
     *
     * @return self
     */
