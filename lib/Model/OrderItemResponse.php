 ...
 */
class OrderItemResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderItemResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['code']) > 200)) {
     ...
     * Sets code
     *
     * @param string $code Internal code for item (internal to e-shop). Used to better identify the item for future changes
     *
     * @return self
     */
    public function setCode($code)
    {
        if ((mb_strlen($code) > 200)) {
            throw new \InvalidArgumentException('invalid length for $code when calling OrderItemResponse., must be smaller than or equal to 200.');
        }
    ...
    public function setEan($ean)
    {
        if (!is_null($ean) && (mb_strlen($ean) > 64)) {
            throw new \InvalidArgumentException('invalid length for $ean when calling OrderItemResponse., must be smaller than or equal to 64.');
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling OrderItemResponse., must be smaller than or equal to 255.');
        }
    ...
    public function setVariant($variant)
    {
        if (!is_null($variant) && (mb_strlen($variant) > 250)) {
            throw new \InvalidArgumentException('invalid length for $variant when calling OrderItemResponse., must be smaller than or equal to 250.');
        }
    ...
    public function setProducer($producer)
    {
        if (!is_null($producer) && (mb_strlen($producer) > 250)) {
            throw new \InvalidArgumentException('invalid length for $producer when calling OrderItemResponse., must be smaller than or equal to 250.');
        }
     ...
     * Sets totalVat
     *
     * @param \SkipPay\Model\VatAmount $totalVat totalVat
     *
     * @return self
     */
    ...
    public function setProductUrl($productUrl)
    {
        if (!is_null($productUrl) && (mb_strlen($productUrl) > 200)) {
            throw new \InvalidArgumentException('invalid length for $productUrl when calling OrderItemResponse., must be smaller than or equal to 200.');
        }
    ...
    public function setDeliveryTrackingNumber($deliveryTrackingNumber)
    {
        if ((mb_strlen($deliveryTrackingNumber) > 64)) {
            throw new \InvalidArgumentException('invalid length for $deliveryTrackingNumber when calling OrderItemResponse., must be smaller than or equal to 64.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling OrderItemResponse., must be bigger than or equal to 1.');
        }
