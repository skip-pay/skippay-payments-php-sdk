...
/**
 * CustomerRequestAllOf Class Doc Comment
 *
 * @category Class
 * @package  SkipPay
 * @author   OpenAPI Generator team
 ...
 */
class CustomerRequestAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerRequest_allOf';
    ...
    public function setFirstName($firstName)
    {
        if (!is_null($firstName) && (mb_strlen($firstName) > 60)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling CustomerRequestAllOf., must be smaller than or equal to 60.');
        }
    ...
    public function setLastName($lastName)
    {
        if (!is_null($lastName) && (mb_strlen($lastName) > 60)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling CustomerRequestAllOf., must be smaller than or equal to 60.');
        }
    ...
    public function setFullName($fullName)
    {
        if (!is_null($fullName) && (mb_strlen($fullName) > 240)) {
            throw new \InvalidArgumentException('invalid length for $fullName when calling CustomerRequestAllOf., must be smaller than or equal to 240.');
        }
    ...
    public function setPhone($phone)
    {
        if ((mb_strlen($phone) > 13)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling CustomerRequestAllOf., must be smaller than or equal to 13.');
        }
