...
/**
 * RecurrenceUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  SkipPay
 * @author   OpenAPI Generator team
 ...
 */
class RecurrenceUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecurrenceUpdateRequest';
     ...
     * Sets state
     *
     * @param string $state This endpoint allows only one option
     *
     * @return self
     */
