...
/**
 * PrecheckCustomerRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PrecheckCustomerRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrecheckCustomerRequest';
    ...
    public function setTitleBefore($titleBefore)
    {
        if (!is_null($titleBefore) && (mb_strlen($titleBefore) > 60)) {
            throw new \InvalidArgumentException('invalid length for $titleBefore when calling PrecheckCustomerRequest., must be smaller than or equal to 60.');
        }
    ...
    public function setTitleAfter($titleAfter)
    {
        if (!is_null($titleAfter) && (mb_strlen($titleAfter) > 60)) {
            throw new \InvalidArgumentException('invalid length for $titleAfter when calling PrecheckCustomerRequest., must be smaller than or equal to 60.');
        }
    ...
    public function setEmail($email)
    {
        if ((mb_strlen($email) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email when calling PrecheckCustomerRequest., must be smaller than or equal to 254.');
        }
    ...
    public function setTin($tin)
    {
        if (!is_null($tin) && (mb_strlen($tin) > 20)) {
            throw new \InvalidArgumentException('invalid length for $tin when calling PrecheckCustomerRequest., must be smaller than or equal to 20.');
        }
    ...
    public function setVatin($vatin)
    {
        if (!is_null($vatin) && (mb_strlen($vatin) > 20)) {
            throw new \InvalidArgumentException('invalid length for $vatin when calling PrecheckCustomerRequest., must be smaller than or equal to 20.');
        }
    ...
    public function setFirstName($firstName)
    {
        if (!is_null($firstName) && (mb_strlen($firstName) > 60)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling PrecheckCustomerRequest., must be smaller than or equal to 60.');
        }
    ...
    public function setLastName($lastName)
    {
        if (!is_null($lastName) && (mb_strlen($lastName) > 60)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling PrecheckCustomerRequest., must be smaller than or equal to 60.');
        }
    ...
    public function setFullName($fullName)
    {
        if (!is_null($fullName) && (mb_strlen($fullName) > 240)) {
            throw new \InvalidArgumentException('invalid length for $fullName when calling PrecheckCustomerRequest., must be smaller than or equal to 240.');
        }
    ...
    public function setPhone($phone)
    {
        if ((mb_strlen($phone) > 13)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling PrecheckCustomerRequest., must be smaller than or equal to 13.');
        }
