...
/**
 * PartnerLoginResult Class Doc Comment
 *
 * @category Class
 ...
 */
class PartnerLoginResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartnerLoginResult';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['accessToken'] === null) {
            $invalidProperties['accessToken'] = "'accessToken' can't be null";
        }
     ...
     * Sets expiresIn
     *
     * @param float|null $expiresIn Token validity remaining time (in seconds)
     *
     * @return self
     */
