...
/**
 * DocumentExtraData Class Doc Comment
 *
 * @category Class
 * @package  SkipPay
 * @author   OpenAPI Generator team
 ...
 */
class DocumentExtraData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentExtraData';
     ...
     * Sets variableSymbol
     *
     * @param string|null $variableSymbol Variable symbol of this document (proforma, invoice, ...)
     *
     * @return self
     */
