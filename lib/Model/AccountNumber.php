 ...
 */
class AccountNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountNumber';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bankCode'] === null) {
            $invalidProperties['bankCode'] = "'bankCode' can't be null";
        }
     ...
     * Sets accountNumber
     *
     * @param string $accountNumber Account number (IBAN, BIC, etc.).
     *
     * @return self
     */
     ...
     * Sets bankCode
     *
     * @param string $bankCode Bank code (SWIFT, etc.).
     *
     * @return self
     */
