...
/**
 * CustomerBase Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomerBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerBase';
    ...
    public function setTitleBefore($titleBefore)
    {
        if (!is_null($titleBefore) && (mb_strlen($titleBefore) > 60)) {
            throw new \InvalidArgumentException('invalid length for $titleBefore when calling CustomerBase., must be smaller than or equal to 60.');
        }
    ...
    public function setTitleAfter($titleAfter)
    {
        if (!is_null($titleAfter) && (mb_strlen($titleAfter) > 60)) {
            throw new \InvalidArgumentException('invalid length for $titleAfter when calling CustomerBase., must be smaller than or equal to 60.');
        }
    ...
    public function setEmail($email)
    {
        if ((mb_strlen($email) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CustomerBase., must be smaller than or equal to 254.');
        }
    ...
    public function setTin($tin)
    {
        if (!is_null($tin) && (mb_strlen($tin) > 20)) {
            throw new \InvalidArgumentException('invalid length for $tin when calling CustomerBase., must be smaller than or equal to 20.');
        }
    ...
    public function setVatin($vatin)
    {
        if (!is_null($vatin) && (mb_strlen($vatin) > 20)) {
            throw new \InvalidArgumentException('invalid length for $vatin when calling CustomerBase., must be smaller than or equal to 20.');
        }
